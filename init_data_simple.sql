...
-- 插入仓库位置数据
INSERT IGNORE INTO warehouse_locations (warehouse_code, row_number, column_number, has_pallet, material_status) VALUES
('A', 1, 1, FALSE, 'EMPTY'),
('A', 1, 2, FALSE, 'EMPTY'),
('A', 1, 3, FALSE, 'EMPTY'),
('A', 1, 4, FALSE, 'EMPTY'),
...
-- 插入示例托盘数据
INSERT IGNORE INTO pallets (pallet_number, pallet_name, qr_code, warehouse_code, row_number, column_number, is_occupied) VALUES
...
-- 插入示例货物数据
INSERT IGNORE INTO goods (goods_number, goods_name, qr_code, warehouse_code, row_number, column_number, material_status, quantity) VALUES
...
-- 插入设备状态数据
INSERT IGNORE INTO device_status (status, current_row, current_col, control_mode, warehouse_selection) VALUES
('IDLE', 0, 0, 'LOCAL', '未选择');

-- 显示创建结果
SELECT 'Database initialization completed successfully!' as status;
SELECT COUNT(*) as location_count FROM warehouse_locations;
SELECT COUNT(*) as pallet_count FROM pallets;
SELECT COUNT(*) as goods_count FROM goods;
SELECT COUNT(*) as device_count FROM device_status;
